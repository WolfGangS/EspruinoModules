function c(a){return 1*(0|a[0])+2*(0|a[1])+4*(0|a[2])+8*(0|a[3])}function d(a){for(var c=0,b=0;b<a.length;b++)c^=a[b];return c}function f(a,e){if(d(a.substr(21,7))!=a[28])return e("Bad minutes");var b=c(a.substr(21,4))+10*c(a.substr(25,3));if(d(a.substr(29,6))!=a[35])return e("Bad hours");var g=c(a.substr(29,4))+10*c(a.substr(33,2));if(d(a.substr(36,22))!=a[58])return e("Bad date");var h=c(a.substr(36,4))+10*c(a.substr(40,2));c(a.substr(42,3));var f=c(a.substr(45,4))+10*c(a.substr(49,
