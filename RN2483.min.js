function f(b){b=E.toString(b);var a="",c;for(c in b)a+=(b.charCodeAt(c)+256).toString(16).substr(-2);return a}function g(b,a){for(var c="",e=a;e<b.length;e+=2)c+=String.fromCharCode(parseInt(b.substr(e,2),16));return c}function d(b,a){this.ser=b;this.options=a||{};this.at=require("AT").connect(b);this.options.debug&&this.at.debug();var c=this;this.at.registerLine("mac_rx 1",function(a){c.emit("message",g(a,9))});this.macOn=!0}d.prototype.reset=function(b){this.options.reset?(this.options.reset.reset(),
